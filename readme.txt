...
Installing "Gravityforms Instant Quote" can be done either by searching for "Gravityforms Instant Quote" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
